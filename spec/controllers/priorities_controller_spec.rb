  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved priority as @priority" do
        ...
        post :create, {:priority => { "name" => "invalid value" }}, valid_session
        assigns(:priority).should be_a_new(Priority)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested priority" do
        ...
        Priority.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => priority.to_param, :priority => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the priority as @priority" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Priority.any_instance.stub(:save).and_return(false)
        put :update, {:id => priority.to_param, :priority => { "name" => "invalid value" }}, valid_session
        assigns(:priority).should eq(priority)
      end
