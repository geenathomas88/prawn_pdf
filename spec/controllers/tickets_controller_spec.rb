...
describe TicketsController,:type => :controller do
    ...
    before (:each) do
      ...
      sign_in @user
      @role = FactoryGirl.create(:ticket)
    end
  ...
  describe 'create' do
    ...
    it "should not create a role without rolename" do
      @ticket1 = Ticket.create(:job_ticket_no=>1,:client_id=>"")
      post :create
  ...
  describe 'export_xls' do
    it "should export tickets list in xls" do                       
        get :export_xls, {}, :format => :xls              
  ...
  #       post :create, {:ticket => { "date" => "invalid value" }}, valid_session
  #       assigns(:ticket).should be_a_new(Ticket)
  #     end
  ...
  #       Ticket.any_instance.should_receive(:update_attributes).with({ "date" => "2012-12-12" })
  #       put :update, {:id => ticket.to_param, :ticket => { "date" => "2012-12-12" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Ticket.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => ticket.to_param, :ticket => { "date" => "invalid value" }}, valid_session
  #       assigns(:ticket).should eq(ticket)
  #     end
